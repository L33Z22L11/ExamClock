...
exam[30] = function () {
  ...
  slogan.$main = parseInt(19150.7 - Date.now() / 864E5) + "天后的高考不相信眼泪";
...
exam[20] = function () {
  // 朴神要搞事情了吗
  slogan.$main = "距离水考" + parseInt((new Date("2022-03-26T22:30+08:00") - Date.now()) / 864E5) + "天";
  if (today.day) {
    // 非周日的白天
