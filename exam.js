...
exam[31] = function () {
  ...
  $("语文", "2022-03-25", "14:30", "17:00");
  $("数学", "2022-03-25", "19:00", "21:00");
  $("自习", "2022-03-25", "21:10", "22:00");
  $("综合", "2022-03-26", "08:00", "10:30", 0,
    ["<a onclick='subject.to(32)'>点击切换为8:00~10:00</a>"]);
  $("英语", "2022-03-26", "14:30", "16:30");
  return "高三";
};
exam[32] = function () {
  $("综合", "2022-03-26", "08:00", "10:00", 0,
    ["<a onclick='subject.to(31)'>点击重置考试时间</a>"]);
  return "[临时]";
}
exam[20] = function () {
  // 朴神要搞事情了吗
