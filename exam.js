    ...
    case "高三素质拓展":
      ...
      subject.update = function () {
        ...
        if (today.day == 0) {
          ...
          $(["综合", "语文",][today.week % 2], today.date, "14:10", "16:40", null, ["第" + today.week + "周" + today.weekday + "大考练"]);
        ...
        if (today.day == 6) {
          ...
          if (today.day == 2 || today.day == 4) {
            ...
            $("考练", today.date, "16:05", "16:50", null, ["年前素质拓展: 周四物理/文数限时纠错训练"]);
            // } else {
          ...
          $("晚三", today.date, "20:50", "22:00", null, ["抬头六十秒，浪费一分钟。", "抬头半分钟，浪费三十秒。", "现在抬头的你看到的是我写的废话。", "自习要专注! ——2019级文科一班",]);
          $("晚修", today.date, "22:00", "23:00");
        }
      };
      break;
    case "高三一检":
      slogan.$sub = ["2022年宝鸡市高考模拟检测(一): 请以司号及广播通知为准。"];
      subject.update = function () {
