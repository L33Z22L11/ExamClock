...
exam[30] = function () {
  ...
  if (today.day == 6) {
    ...
    if (today.day == 2 || today.day == 4) {
      ...
      $("考练", today.date, "16:05", "16:50", 0, ["年前素质拓展：周四物理/文数限时纠错训练"]);
      // } else {
    ...
    $("晚训", today.date, "18:25", "18:45", 0, ["年前素质拓展：" + today.weekday + (["英语", "语文", "地理/物理", "数学", "政治/化学", "历史/生物",][today.day] || "无") + "小题精练"]);
...
exam[31] = function () {
  ...
  $("语文", "2022-02-08", "14:00", "16:30");
  $("自习", "2022-02-08", "16:40", "17:45");
  $("数学", "2022-02-09", "07:40", "09:40");
  $("英语", "2022-02-09", "10:00", "12:00");
  $("综合", "2022-02-09", "14:00", "16:30");
  return "高三";
};
exam[21] = function () {
