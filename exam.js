...
exam[30] = function () {
  ...
  if (today.day == 6) {
    ...
    $("晚三", today.date, "20:50", "22:00", 0, ["自习要专注! ——2019级文科一班", "现在抬头的你，将会看到我写的废话如下：", "抬头半分钟，浪费三十秒。", "抬头六十秒，浪费一分钟。", "抬头半节晚三，脖子会酸。", "浪费一节晚三，它不会再回来。", "综上所述，据不完全归纳，抬头会浪费时间。", "少看废话多学习，宝中生活才如意。", "在理想的生产环境中，没有用户会看到这句话，但消磨时光的人除外。",]);
