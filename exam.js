...
exam[21] = function () {
  slogan.$sub = ["高二第二学期期末考试(理科)：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-06-29", "07:40", "10:10");
  $("地理", "2022-06-29", "10:40", "12:20");
  $("数学", "2022-06-29", "14:20", "16:20");
  $("化学", "2022-06-29", "16:50", "18:30");
  $("英语", "2022-06-30", "07:20", "09:50");
  $("物理", "2022-06-30", "10:20", "12:00");
  return "高二理科";
};
exam[22] = function () {
  slogan.$sub = ["高二第二学期期末考试(文科)：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-06-29", "07:40", "10:10");
  $("地理", "2022-06-29", "10:40", "12:20");
  $("数学", "2022-06-29", "14:20", "16:20");
  $("历史", "2022-06-29", "16:50", "18:30");
  $("英语", "2022-06-30", "07:20", "09:50");
  $("政治", "2022-06-30", "10:20", "12:00");
  return "高二文科";
};
exam[11] = function () {
  slogan.$sub = ["高一期末考试：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-06-29", "07:50", "10:510");
