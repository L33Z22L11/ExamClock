...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["高三第一学期月考二：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-11-01", "07:40", "10:10");
    $("化学", "2024-11-01", "10:40", "12:10");
    $("英语", "2024-11-01", "14:10", "16:10");
    $("地理", "2024-11-01", "16:40", "18:10");
    $("数学", "2024-11-02", "08:00", "10:00");
    $("生物", "2024-11-02", "10:30", "12:00");
    $("政治", "2024-11-02", "14:10", "15:40");
    $("物理", "2024-11-02", "16:10", "17:40");
  }
};
...
exams[261] = {
  ...
  author: "来源:@_浩子没有尾汁",
  origin: "2026届年级部",
  rollSlogan: ["2023级高二第一学期期中考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-11-08", "07:40", "10:10");
    $("政治", "2024-11-08", "10:40", "12:10");
    $("英语", "2024-11-08", "14:10", "16:10");
    $("地理", "2024-11-08", "16:40", "18:10");
    $("数学", "2024-11-09", "08:00", "10:00");
    $("生物", "2024-11-09", "10:30", "12:00");
    $("化学", "2024-11-09", "14:10", "15:40");
    $("物史", "2024-11-09", "16:10", "17:40");
  }
};
...
exams[271] = {
  ...
  schedule() {
    $("语文", "2024-11-08", "08:00", "10:00");
    $("物理", "2024-11-08", "10:30", "12:00");
    $("史地", "2024-11-08", "14:10", "16:10");
    $("生物", "2024-11-08", "16:40", "18:10");
    $("数学", "2024-11-09", "08:00", "09:40");
    $("化学", "2024-11-09", "10:10", "11:40");
    $("英语", "2024-11-09", "14:10", "15:50");
    $("政治", "2024-11-09", "16:20", "17:20");
  }
};
