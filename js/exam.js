...
exams[261] = {
  ...
  author: "来源:@_浩子没有尾汁",
  origin: "2026届年级部",
  rollSlogan: ["2026年宝鸡市高考模拟检测（三）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-04-24", "09:00", "11:30");
    $("数学", "2026-04-24", "15:00", "17:00");
    $("物理", "2026-04-25", "09:00", "10:15");
    $("英语", "2026-04-25", "15:00", "17:00");
    $("化学", "2026-04-26", "08:30", "09:45");
    $("地理", "2026-04-26", "11:00", "12:15");
    $("政治", "2026-04-26", "14:30", "15:45");
    $("生物", "2026-04-26", "17:00", "18:15");
  }
};
...
exams[271] = {
  ...
  author: "来源:caitong",
  origin: "2027届年级部",
  rollSlogan: ["高二第二学期期中考试：请以实际铃声为准。"],
  schedule() {
    $("英语", "2026-04-22", "14:00", "16:00");
    $("物理", "2026-04-22", "16:30", "18:00");
    $("政治", "2026-04-22", "18:55", "20:25");
    $("语文", "2026-04-23", "07:40", "10:10");
    $("化学", "2026-04-23", "10:40", "12:10");
    $("数学", "2026-04-23", "14:00", "16:00");
    $("生物", "2026-04-23", "16:30", "18:00");
  }
};
...
exams[272] = {
  ...
  schedule() {
    $("英语", "2026-04-22", "14:00", "16:00");
    $("历史", "2026-04-22", "16:30", "18:00");
    $("政治", "2026-04-22", "18:55", "20:25");
    $("语文", "2026-04-23", "07:40", "10:10");
    $("化学", "2026-04-23", "10:40", "12:10");
    $("数学", "2026-04-23", "14:00", "16:00");
    $("地理", "2026-04-23", "16:30", "18:00");
  }
};
...
exams[281] = {
  ...
  origin: "2028届年级部",
  rollSlogan: ["高一第二学期期中考试：请以实际铃声为准。"],
  schedule() {
    $("英语", "2026-04-23", "14:00", "16:00");
    $("物理", "2026-04-23", "16:30", "18:00");
    $("语文", "2026-04-24", "07:40", "10:10");
    $("化学", "2026-04-24", "10:40", "12:10");
    $("数学", "2026-04-24", "14:00", "16:00");
    $("生物", "2026-04-24", "16:30", "18:00");
  }
};
