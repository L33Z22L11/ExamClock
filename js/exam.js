...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡中学九轮模拟考练(第六次)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-05-12", "07:55", "10:25");
    $("物理", "2025-05-12", "10:45", "12:00");
    $("化学", "2025-05-12", "14:25", "15:40");
    $("选2", "2025-05-12", "15:50", "17:05");
    $("数学", "2025-05-13", "07:40", "09:40");
    $("英语", "2025-05-13", "10:00", "12:00");
  }
};
...
exams[252] = {
  ...
  schedule() {
    $("语文", "2025-05-12", "07:55", "10:25");
    $("历史", "2025-05-12", "10:45", "12:00");
    $("政治", "2025-05-12", "14:25", "15:40");
    $("选2", "2025-05-12", "15:50", "17:05");
    $("数学", "2025-05-13", "07:40", "09:40");
    $("英语", "2025-05-13", "10:00", "12:00");
  }
