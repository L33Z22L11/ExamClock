...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡中学九轮模拟考练(第三次)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-05-01", "07:55", "10:25");
    $("物理", "2025-05-01", "10:45", "12:00");
    $("化学", "2025-05-01", "14:25", "15:40");
    $("选2", "2025-05-01", "16:00", "17:15");
    $("数学", "2025-05-02", "07:40", "09:40");
    $("英语", "2025-05-02", "10:00", "12:00");
  }
};
...
exams[252] = {
  ...
  schedule() {
    $("语文", "2025-05-01", "07:55", "10:25");
    $("历史", "2025-05-01", "10:45", "12:00");
    $("政治", "2025-05-01", "14:25", "15:40");
    $("选2", "2025-05-01", "16:00", "17:15");
    $("数学", "2025-05-02", "07:40", "09:40");
    $("英语", "2025-05-02", "10:00", "12:00");
  }
