...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["高三第一学期月考三：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-11-29", "14:00", "16:30");
    $("物理", "2024-11-29", "16:50", "18:05");
    $("数学", "2024-11-30", "07:40", "09:40");
    $("英语", "2024-11-30", "10:00", "12:00");
    $("选1", "2024-11-30", "14:30", "15:45");
    $("选2", "2024-11-30", "15:55", "17:10");
  }
};
