...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2026宝鸡市高考模拟检测（二）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-03-21", "08:00", "10:30");
    $("地理", "2026-03-21", "11:00", "12:15");
    $("数学", "2026-03-21", "14:30", "16:30");
    $("生物", "2026-03-21", "17:00", "18:15");
    $("物理", "2026-03-22", "08:30", "09:45");
    $("化学", "2026-03-22", "10:15", "11:30");
    $("英语", "2026-03-22", "14:30", "16:30");
    $("政治", "2026-03-22", "17:00", "18:15");
  }
};
...
exams[271] = {
  ...
  author: "来源:caitong",
  origin: "2027届年级部",
  rollSlogan: ["高二第二学期阶段一考试：请以实际铃声为准。"],
  schedule() {
    $("英语", "2026-03-26", "14:00", "16:00");
    $("化学", "2026-03-26", "16:30", "18:00");
    $("政治", "2026-03-26", "18:55", "20:25");
    $("语文", "2026-03-27", "07:40", "10:10");
    $("物理", "2026-03-27", "10:40", "12:10");
    $("数学", "2026-03-27", "14:00", "16:00");
    $("生物", "2026-03-27", "16:30", "18:00");
  }
};
...
exams[272] = {
  ...
  schedule() {
    ...
    $("政治", "2026-03-26", "18:55", "20:25");
    $("语文", "2026-03-27", "07:40", "10:10");
    $("历史", "2026-03-27", "10:40", "12:10");
    $("数学", "2026-03-27", "14:00", "16:00");
    $("地理", "2026-03-27", "16:30", "18:00");
  }
};
...
exams[281] = {
  ...
  origin: "2028届年级部",
  rollSlogan: ["高一第二学期阶段一考试：请以实际铃声为准。"],
  schedule() {
    $("数学", "2026-03-26", "14:00", "16:00");
    $("化学", "2026-03-26", "16:30", "18:00");
    $("语文", "2026-03-27", "07:40", "10:10");
    $("物理", "2026-03-27", "10:40", "12:10");
    $("英语", "2026-03-27", "14:00", "16:00");
    $("生物", "2026-03-27", "16:30", "18:00");
  }
};
