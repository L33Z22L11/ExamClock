...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡中学九轮模拟考练(第一次)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-04-24", "07:55", "10:25");
    $("物理", "2025-04-24", "10:45", "12:00");
    $("化学", "2025-04-24", "14:20", "15:35");
    $("选2", "2025-04-24", "15:45", "17:00");
    $("数学", "2025-04-25", "07:40", "09:40");
    $("英语", "2025-04-25", "10:00", "12:00");
  }
};
...
exams[252] = {
  ...
  schedule() {
    $("语文", "2025-04-24", "07:55", "10:25");
    $("历史", "2025-04-24", "10:45", "12:00");
    $("政治", "2025-04-24", "14:20", "15:35");
    $("选2", "2025-04-24", "15:45", "17:00");
    $("数学", "2025-04-25", "07:40", "09:40");
    $("英语", "2025-04-25", "10:00", "12:00");
  }
