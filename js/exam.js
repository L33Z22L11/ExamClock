...
exam[251] = function () {
  slogan.$sub = ["高二诊断性考试：请以实际铃声为准。"];
  $("生物", "2023-08-26", "07:40", "09:10");
  $("语文", "2023-08-26", "09:40", "12:10");
  $("政治", "2023-08-26", "14:20", "15:50");
  $("数学", "2023-08-26", "16:20", "18:20");
  $("地理", "2023-08-27", "08:00", "09:30");
  $("英语", "2023-08-27", "10:00", "12:00");
  $("化学", "2023-08-27", "14:20", "15:50");
  $("物理", "2023-08-27", "16:20", "17:50");
  return "高二物理";
};
exam[252] = function () {
  $("生物", "2023-08-26", "07:40", "09:10");
