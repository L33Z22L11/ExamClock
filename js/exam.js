...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "中华人民共和国教育部",
  rollSlogan: ["2026年普通高等学校招生全国统一考试：请以考点实际铃声为准。"],
  schedule() {
    $("语文", "2026-06-07", "09:00", "11:30");
    $("数学", "2026-06-07", "15:00", "17:00");
    $("物理", "2026-06-08", "09:00", "10:15");
    $("外语", "2026-06-08", "15:00", "17:00");
    $("化学", "2026-06-09", "08:30", "09:45");
    $("地理", "2026-06-09", "11:00", "12:15");
    $("思想政治", "2026-06-09", "14:30", "15:45");
    $("生物学", "2026-06-09", "17:00", "18:15");
  }
};
...
exams[271] = {
  ...
  author: "来源:caitong",
  origin: "2027届年级部",
  rollSlogan: ["高二第二学期阶段二考试：请以实际铃声为准。"],
  schedule() {
    $("化学", "2026-05-28", "14:20", "15:50");
    $("英语", "2026-05-28", "16:20", "18:20");
    $("生物", "2026-05-28", "19:15", "20:45");
    $("语文", "2026-05-29", "07:40", "10:10");
    $("物理", "2026-05-29", "10:40", "12:10");
    $("数学", "2026-05-29", "14:20", "16:20");
    $("政治", "2026-05-29", "16:50", "18:20");
  }
};
...
exams[272] = {
  ...
  schedule() {
    $("化学", "2026-05-28", "14:20", "15:50");
    $("英语", "2026-05-28", "16:20", "18:20");
    $("地理", "2026-05-28", "19:15", "20:45");
    $("语文", "2026-05-29", "07:40", "10:10");
    $("历史", "2026-05-29", "10:40", "12:10");
    $("数学", "2026-05-29", "14:20", "16:20");
    $("政治", "2026-05-29", "16:50", "18:20");
  }
};
...
exams[281] = {
  ...
  origin: "2028届年级部",
  rollSlogan: ["高一第二学期第二次月考：请以实际铃声为准。"],
  schedule() {
    $("数学", "2026-05-31", "16:30", "18:30");
    $("生物", "2026-05-31", "19:15", "20:45");
    $("语文", "2026-06-01", "07:40", "10:10");
    $("化学", "2026-06-01", "10:40", "12:10");
    $("英语", "2026-06-01", "14:20", "16:20");
    $("物理", "2026-06-01", "16:50", "18:20");
  }
};
...
exams[291] = {
  ...
  author: "来源:高一30班 Lucas A Danny",
  origin: "贯通培养实验班教学计划",
  rollSlogan: ["实验班质检一：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-03-27", "08:00", "10:00");
    $("物理", "2026-03-27", "10:30", "12:00");
    $("数学", "2026-03-27", "14:00", "15:40");
    $("英语", "2026-03-27", "16:10", "17:50");
    $("化学", "2026-03-27", "18:55", "20:25");
  }
};
