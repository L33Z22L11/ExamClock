...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["高三三轮模拟考练（四）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-05-04", "08:00", "10:30");
    $("物理", "2026-05-04", "10:45", "12:00");
    $("选科1", "2026-05-04", "14:25", "15:40");
    $("选科2", "2026-05-04", "15:45", "17:00");
    $("数学", "2026-05-05", "08:00", "10:00");
    $("英语", "2026-05-05", "10:15", "12:15");
  }
};
