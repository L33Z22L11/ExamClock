...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["高三第一学期诊断性考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-08-27", "07:40", "10:10");
    $("生物", "2024-08-27", "10:40", "12:10");
    $("数学", "2024-08-27", "14:20", "16:20");
    $("物理", "2024-08-27", "16:50", "18:20");
    $("英语", "2024-08-28", "08:00", "10:00");
    $("地理", "2024-08-28", "10:30", "12:00");
    $("化学", "2024-08-28", "14:20", "15:50");
    $("政治", "2024-08-28", "16:20", "17:50");
  }
};
exams[252] = {
  type: "高三历史",
