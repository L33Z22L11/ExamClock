...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["高二年级下阶段二考试：请以实际铃声为准"],
  schedule() {
    $("语文", "2025-06-03", "07:40", "10:10");
    $("物理", "2025-06-03", "10:40", "11:55");
    $("选科一", "2025-06-03", "14:20", "15:35");
    $("选科二", "2025-06-03", "15:45", "17:00");
    $("数学", "2025-06-04", "07:40", "09:40");
    $("英语", "2025-06-04", "10:10", "12:10");
  }
};
...
exams[262] = {
  ...
  schedule() {
    $("语文", "2025-06-03", "07:40", "10:10");
    $("历史", "2025-06-03", "10:40", "11:55");
    $("政治", "2025-06-03", "14:20", "15:35");
    $("地理", "2025-06-03", "15:45", "17:00");
    $("数学", "2025-06-04", "07:40", "09:40");
    $("英语", "2025-06-04", "10:10", "12:10");
  }
};
