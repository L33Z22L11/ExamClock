...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["宝鸡中学2023级高三模考（6）：请以实际铃声为准。"],
  schedule() {
    $("数学", "2026-05-11", "08:00", "10:00");
    $("英语", "2026-05-11", "10:15", "12:15");
    $("语文", "2026-05-11", "14:25", "16:55");
    $("物理", "2026-05-11", "17:10", "18:25");
    $("选科1", "2026-05-12", "07:55", "09:10");
    $("选科2", "2026-05-12", "09:15", "10:30");
  }
};
