...
exams[261] = {
  type: "高三物理",
  author: "来源:杨一涵、ZXL、SHZ",
  origin: "2026届年级部",
  rollSlogan: ["高三模考（9）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-05-21", "08:00", "10:30");
    $("物理", "2026-05-21", "10:45", "12:00");
    $("选科1", "2026-05-21", "14:25", "15:40");
    $("选科2", "2026-05-21", "15:45", "17:00");
    $("数学", "2026-05-22", "08:00", "10:00");
    $("英语", "2026-05-22", "10:15", "12:15");
  }
};
