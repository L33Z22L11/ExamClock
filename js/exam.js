...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2023级高三月考（五）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-01-30", "14:10", "16:10");
    $("物理", "2026-01-30", "17:00", "18:15");
    $("数学", "2026-01-31", "07:50", "09:50");
    $("英语", "2026-01-31", "10:10", "12:10");
    $("选科一", "2026-01-31", "14:10", "15:25");
    $("选科二", "2026-01-31", "15:30", "16:45");
