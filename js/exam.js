...
exam[231] = function () {
  slogan.$sub = ["高三第一学期质检一：请以实际铃声为准。"];
  $("语文", "2022-12-24", "09:00", "11:30");
  $("数学", "2022-12-24", "15:00", "17:00");
  $("综合", "2022-12-25", "09:00", "11:30");
  $("英语", "2022-12-25", "15:00", "17:00");
  return "高三线下";
};
exam[232] = function () {
  slogan.$sub = ["高三第一学期质检一(线上)"];
  $("(综合)", "2022-12-24", "09:00", "11:30");
  $("语文", "2022-12-24", "15:00", "17:30");
  $("数学", "2022-12-24", "19:00", "21:00");
  $("(语文)", "2022-12-25", "09:00", "11:30");
  $("综合", "2022-12-25", "15:00", "17:30");
  $("英语", "2022-12-25", "19:00", "21:00");
  return "高三线上";
};
exam[241] = function () {
  slogan.$sub = ["高二第一学期期中暨模块结业考试(理科)：请以实际铃声为准。"];
  slogan.$sub = ["请在野生技协群内发布考试时间。"];
  $("数学", "2022-11-04", "14:00", "16:00");
  $("生物", "2022-11-04", "16:30", "18:10");
  $("语文", "2022-11-05", "07:40", "10:10");
  $("物理", "2022-11-05", "10:40", "12:20");
  $("英语", "2022-11-05", "14:00", "16:00");
  $("化学", "2022-11-05", "16:30", "18:10");
  return "高二理科";
};
exam[242] = function () {
  slogan.$sub = ["高二第一学期期中暨模块结业考试(文科)：请以实际铃声为准。"];
  slogan.$sub = ["请在野生技协群内发布考试时间。"];
  $("数学", "2022-11-04", "14:00", "16:00");
  $("地理", "2022-11-04", "16:30", "18:10");
  $("语文", "2022-11-05", "07:40", "10:10");
  $("政治", "2022-11-05", "10:40", "12:20");
  $("英语", "2022-11-05", "14:00", "16:00");
  $("历史", "2022-11-05", "16:30", "18:10");
  return "高二文科";
};
exam[251] = function () {
  slogan.$sub = ["高一第一学期期中暨模块结业考试：请以实际铃声为准。"];
  slogan.$sub = ["请在野生技协群内发布考试时间。"];
  $("语文", "2022-11-04", "08:00", "10:00");
  $("生物", "2022-11-04", "10:30", "12:10");
  $("英语", "2022-11-04", "14:00", "15:40");
  $("物理", "2022-11-04", "16:10", "17:50");
  $("政史", "2022-11-05", "08:00", "10:00");
  $("数学", "2022-11-05", "10:30", "12:10");
  $("化学", "2022-11-05", "14:00", "15:40");
  $("地理", "2022-11-05", "16:10", "17:10");
  return "高一理科";
};
