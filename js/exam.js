...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["高二年级期中考试：请以实际铃声为准"],
  schedule() {
    $("语文", "2025-04-11", "07:40", "10:10");
    $("化学", "2025-04-11", "10:40", "12:10");
    $("数学", "2025-04-11", "14:00", "16:00");
    $("政治", "2025-04-11", "16:30", "18:00");
    $("英语", "2025-04-12", "08:00", "10:00");
    $("地理", "2025-04-12", "10:30", "12:00");
    $("生物", "2025-04-12", "14:00", "15:30");
    $("物理", "2025-04-12", "16:00", "17:30");
  }
};
...
exams[271] = {
  ...
  author: "来源:张老师",
  origin: "2027届年级部",
  rollSlogan: ["高一第二学期阶段性考试(二)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-06-03", "07:40", "10:10");
    $("物理", "2025-06-03", "10:40", "12:10");
    $("数学", "2025-06-03", "14:20", "16:20");
    $("政治", "2025-06-03", "16:50", "18:20");
    $("英语", "2025-06-04", "08:00", "10:00");
    $("生物", "2025-06-04", "10:40", "12:10");
    $("地理", "2025-06-04", "14:20", "15:50");
    $("化学", "2025-06-04", "16:20", "17:50");
  }
};
