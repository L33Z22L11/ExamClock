...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡中学九轮模拟考练(第四次)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-05-05", "07:55", "10:25");
    $("物理", "2025-05-05", "10:45", "12:00");
    $("化学", "2025-05-05", "14:25", "15:40");
    $("选2", "2025-05-05", "16:00", "17:15");
    $("数学", "2025-05-06", "07:40", "09:40");
    $("英语", "2025-05-06", "10:00", "12:00");
  }
};
...
exams[252] = {
  ...
  schedule() {
    $("语文", "2025-05-05", "07:55", "10:25");
    $("历史", "2025-05-05", "10:45", "12:00");
    $("政治", "2025-05-05", "14:25", "15:40");
    $("选2", "2025-05-05", "16:00", "17:15");
    $("数学", "2025-05-06", "07:40", "09:40");
    $("英语", "2025-05-06", "10:00", "12:00");
  }
...
exams[271] = {
  ...
  schedule() {
    $("语文", "2025-04-18", "07:40", "10:10");
    $("生物", "2025-04-18", "10:40", "12:10");
    $("数学", "2025-04-18", "14:00", "16:00");
    $("地理", "2025-04-18", "16:30", "18:00");
    $("英语", "2025-04-19", "08:00", "10:00");
    $("物理", "2025-04-19", "10:30", "12:00");
    $("政治", "2025-04-19", "14:00", "15:30");
    $("化学", "2025-04-19", "16:00", "17:30");
  }
};
