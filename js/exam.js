...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡中学九轮模拟考练(第五次)：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-05-09", "07:55", "10:25");
    $("物理", "2025-05-09", "10:45", "12:00");
    $("化学", "2025-05-09", "14:25", "15:40");
    $("选2", "2025-05-09", "15:50", "17:05");
    $("数学", "2025-05-10", "07:40", "09:40");
    $("英语", "2025-05-10", "10:00", "12:00");
  }
};
...
exams[252] = {
  ...
  schedule() {
    $("语文", "2025-05-09", "07:55", "10:25");
    $("历史", "2025-05-09", "10:45", "12:00");
    $("政治", "2025-05-09", "14:25", "15:40");
    $("选2", "2025-05-09", "15:50", "17:05");
    $("数学", "2025-05-10", "07:40", "09:40");
    $("英语", "2025-05-10", "10:00", "12:00");
  }
...
exams[271] = {
  ...
  author: "来源:░▓▓▒",
  origin: "2027届年级部",
  rollSlogan: ["高一第二学期合格模拟考：请以实际铃声为准。"],
  schedule() {
    $("地理", "2025-05-07", "14:25", "15:25");
    $("化学", "2025-05-07", "15:40", "16:40");
    $("生物", "2025-05-07", "16:55", "17:55");
  }
};
