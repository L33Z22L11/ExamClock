...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2023级高三月考（九）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-04-16", "08:00", "10:30");
    $("物理", "2026-04-16", "10:45", "12:00");
    $("选科一", "2026-04-16", "14:10", "15:25");
    $("选科二", "2026-04-16", "15:30", "16:45");
    $("数学", "2026-04-17", "08:00", "10:00");
    $("英语", "2026-04-17", "10:15", "12:15");
  }
};
