...
exams[251] = {
  ...
  schedule() {
    ...
    $("数学", "2024-04-25", "08:00", "10:00");
    $("政治", "2024-04-25", "10:30", "12:00");
    $("地理", "2024-04-25", "14:00", "15:30");
    $("生物", "2024-04-25", "16:00", "17:30");
  }
};
exams[252] = {
  type: "高二历史",
...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026级年级部",
  rollSlogan: ["高一第二学期阶段二考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-05-31", "07:40", "10:10");
    $("物理", "2024-05-31", "10:40", "12:10");
    $("数学", "2024-05-31", "14:00", "16:00");
    $("政治", "2024-05-31", "16:30", "18:00");
    $("英语", "2024-06-01", "08:00", "10:00");
    $("生物", "2024-06-01", "10:30", "12:00");
    $("地理", "2024-06-01", "14:00", "15:30");
    $("化史", "2024-06-01", "16:00", "17:30");
  }
};
