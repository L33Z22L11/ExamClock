...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["宝鸡中学2023级高三模考（5）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-05-07", "08:00", "10:30");
    $("物理", "2026-05-07", "10:45", "12:00");
    $("选科1", "2026-05-07", "14:25", "15:40");
    $("选科2", "2026-05-07", "15:45", "17:00");
    $("数学", "2026-05-08", "08:00", "10:00");
    $("英语", "2026-05-08", "10:15", "12:15");
  }
};
