...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["高三三轮模拟考练（三）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-04-30", "08:00", "10:30");
    $("物理", "2026-04-30", "10:45", "12:00");
    $("选科一", "2026-04-30", "14:10", "15:25");
    $("选科二", "2026-04-30", "15:30", "16:45");
    $("数英", "2026-05-01", "08:00", "10:00");
    $("数英", "2026-05-01", "10:15", "12:15");
  }
};
