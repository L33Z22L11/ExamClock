...
exams[261] = {
  ...
  author: "来源:@_浩子没有尾汁",
  origin: "2026届年级部",
  rollSlogan: ["2026年宝鸡市高考模拟检测一：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-01-10", "08:00", "10:30");
    $("地理", "2026-01-10", "11:00", "12:15");
    $("数学", "2026-01-10", "14:30", "16:30");
    $("生物", "2026-01-10", "17:00", "18:15");
    $("物理", "2026-01-11", "08:30", "09:45");
    $("化学", "2026-01-11", "10:15", "11:30");
    $("英语", "2026-01-11", "14:30", "16:30");
    $("政治", "2026-01-11", "17:00", "18:15");
  }
};
...
exams[271] = {
  ...
  author: "来源:阳毅",
  origin: "2027届年级部",
  rollSlogan: ["高二第一学期期末考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-01-28", "07:40", "10:10");
    $("生物", "2026-01-28", "10:40", "12:10");
    $("数学", "2026-01-28", "14:10", "16:10");
    $("英语", "2026-01-29", "08:00", "10:00");
    $("化学", "2026-01-29", "10:30", "12:00");
    $("政治", "2026-01-29", "14:10", "15:40");
    $("物理", "2026-01-29", "16:10", "17:40");
  }
};
...
exams[272] = {
  ...
  schedule() {
    $("语文", "2026-01-28", "07:40", "10:10");
    $("地理", "2026-01-28", "10:40", "12:10");
    $("数学", "2026-01-28", "14:10", "16:10");
    $("英语", "2026-01-29", "08:00", "10:00");
    $("化学", "2026-01-29", "10:30", "12:00");
    $("政治", "2026-01-29", "14:10", "15:40");
    $("历史", "2026-01-29", "16:10", "17:40");
  }
};
