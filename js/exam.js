...
exam[231] = function () {
  slogan.$sub = ["高三第一学期月考三(理科)：请以实际铃声为准。"];
  $("数学", "2022-12-02", "14:00", "16:00");
  $("化学", "2022-12-02", "16:30", "18:10");
  $("语文", "2022-12-03", "07:40", "10:10");
  $("物理", "2022-12-03", "10:40", "12:20");
  $("英语", "2022-12-03", "14:00", "16:00");
  $("生物", "2022-12-03", "16:30", "18:10");
  return "高三理科";
};
exam[232] = function () {
  slogan.$sub = ["高三第一学期月考三(文科)：请以实际铃声为准。"];
  $("数学", "2022-12-02", "14:00", "16:00");
  $("历史", "2022-12-02", "16:30", "18:10");
  $("语文", "2022-12-03", "07:40", "10:10");
  $("政治", "2022-12-03", "10:40", "12:20");
  $("英语", "2022-12-03", "14:00", "16:00");
  $("地理", "2022-12-03", "16:30", "18:10");
 return "高三文科";
};
exam[241] = function () {
