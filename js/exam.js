...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2023级高三四月阶段练习（二）：请以实际铃声为准。"],
  schedule() {
    $("选科一", "2026-04-19", "14:10", "15:25");
    $("选科二", "2026-04-19", "15:30", "16:45");
    $("物理", "2026-04-19", "16:55", "18:10");
    $("数学", "2026-04-20", "08:00", "10:00");
    $("英语", "2026-04-20", "10:15", "12:15");
    $("语文", "2026-04-20", "14:10", "16:40");
  }
};
