...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["月考6：请以实际铃声为准。"],
  schedule() {
    $("复习", "2026-02-28", "14:10", "14:50");
    $("化学", "2026-02-28", "15:10", "16:25");
    $("生政地", "2026-02-28", "16:30", "17:45");
    $("数学", "2026-03-01", "07:50", "09:50");
    $("英语", "2026-03-01", "10:10", "12:10");
    $("语文", "2026-03-01", "14:10", "16:40");
    $("物理", "2026-03-01", "17:00", "18:15");
...
exams[262] = {
  ...
  schedule() {
    $("复习", "2026-02-28", "14:10", "14:50");
    $("政治", "2026-02-28", "15:10", "16:25");
    $("地理", "2026-02-28", "16:30", "17:45");
    $("数学", "2026-03-01", "07:50", "09:50");
    $("英语", "2026-03-01", "10:10", "12:10");
    $("语文", "2026-03-01", "14:10", "16:40");
    $("历史", "2026-03-01", "17:00", "18:15");
    //$("物理", "2025-12-06", "16:10", "17:40");
  }
};
...
exams[281] = {
  ...
  schedule() {
    $("语文", "2026-01-28", "08:00", "10:00");
    $("物理", "2026-01-28", "10:30", "12:00");
    $("英语", "2026-01-28", "14:10", "15:50");
    $("生物", "2026-01-28", "16:20", "17:50");
    $("政史", "2026-01-29", "08:00", "10:00");
    $("化学", "2026-01-29", "10:30", "12:00");
    $("数学", "2026-01-29", "14:10", "15:50");
    $("地理", "2026-01-29", "16:20", "17:20");
  }
};
