...
exams[251] = {
  ...
  author: "招募“高二物理”维护者",
  origin: "2025级年级部",
  rollSlogan: ["高二第一学期期末暨模块结业考试：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-01-26", "07:40", "10:10");
    $("生物", "2024-01-26", "10:30", "12:10");
    $("英语", "2024-01-26", "14:00", "16:00");
    $("地理", "2024-01-26", "16:30", "18:00");
    $("数学", "2024-01-27", "08:00", "10:00");
    $("化学", "2024-01-27", "10:30", "12:00");
    $("政治", "2024-01-27", "14:00", "15:30");
    $("物理", "2024-01-27", "16:00", "17:30");
  }
};
exams[252] = {
  type: "高二历史",
...
exams[261] = {
  ...
  author: "心向太阳",
  origin: "2026级年级部",
  rollSlogan: ["高一第二学期第一次月考：请以实际铃声为准。"],
  schedule() {
    $("语文", "2024-03-22", "07:40", "10:10");
    $("化学", "2024-03-22", "10:40", "12:10");
    $("数学", "2024-03-22", "14:00", "16:00");
    $("政治", "2024-03-22", "16:30", "18:00");
    $("英语", "2024-03-23", "08:00", "10:00");
    $("生物", "2024-03-23", "10:30", "12:00");
    $("地理", "2024-03-23", "14:00", "15:30");
    $("理史", "2024-03-23", "16:00", "17:30");
  }
};
