...
exam[251] = function () {
  slogan.$sub = ["高二第一学期阶段一考试：请以实际铃声为准。"];
  $("语文", "2023-10-07", "07:40", "10:10");
  $("生物", "2023-10-07", "10:40", "12:10");
  $("数学", "2023-10-07", "14:00", "16:00");
  $("物理", "2023-10-07", "16:30", "18:00");
  $("英语", "2023-10-08", "08:00", "10:00");
  $("地理", "2023-10-08", "10:30", "12:00");
  $("政治", "2023-10-08", "14:00", "15:30");
  $("化学", "2023-10-08", "16:00", "17:30");
  return "高二物理";
};
exam[252] = function () {
  slogan.$sub = ["高二第一学期阶段一考试：请以实际铃声为准。"];
...
exam[261] = function () {
  slogan.$sub = ["高一第一学期月考一：请以实际铃声为准。"];
  $("语文", "2023-10-07", "08:00", "10:00");
  $("化学", "2023-10-07", "10:30", "12:00");
  $("数学", "2023-10-07", "14:00", "15:40");
  $("生物", "2023-10-07", "16:10", "17:40");
  $("政地", "2023-10-08", "08:00", "10:00");
  $("物理", "2023-10-08", "10:30", "12:00");
  $("英语", "2023-10-08", "14:00", "15:40");
  $("历史", "2023-10-08", "16:10", "17:10");
  return "高一";
};
