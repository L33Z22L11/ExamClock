...
exams[251] = {
  ...
  author: "来源:望戈",
  origin: "2025级年级部",
  rollSlogan: ["宝鸡市高考模拟检测（二）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-03-02", "09:00", "11:30");
    $("数学", "2025-03-02", "15:00", "17:00");
    $("物理", "2025-03-03", "09:00", "10:15");
    $("英语", "2025-03-03", "15:00", "17:00");
    $("化学", "2025-03-04", "08:30", "09:45");
    $("地理", "2025-03-04", "11:00", "12:15");
    $("思政", "2025-03-04", "14:30", "15:45");
    $("生物", "2025-03-04", "17:00", "18:15");
  }
};
...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["高二第一学期月考一：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-03-14", "07:40", "10:10");
    $("化学", "2025-03-14", "10:40", "12:10");
    $("数学", "2025-03-14", "14:00", "16:00");
    $("政治", "2025-03-14", "16:30", "18:00");
    $("英语", "2025-03-15", "08:00", "10:00");
    $("地理", "2025-03-15", "10:30", "12:00");
    $("生物", "2025-03-15", "14:00", "15:30");
...
exams[271] = {
  ...
  rollSlogan: ["高二第一学期月考一：请以实际铃声为准。"],
  schedule() {
    $("语文", "2025-03-14", "08:00", "10:00");
    $("化学", "2025-03-14", "10:30", "12:10");
