...
exam[231] = function () {
  slogan.$sub = ["高三诊断性考试(理科)：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-08-26", "07:40", "10:10");
  $("物理", "2022-08-26", "10:40", "12:20");
  $("英语", "2022-08-26", "14:20", "16:20");
  $("化学", "2022-08-26", "16:50", "18:30");
  $("数学", "2022-08-27", "07:50", "09:50");
  $("生物", "2022-08-27", "10:20", "12:00");
  return "高三理科";
};
exam[232] = function () {
  slogan.$sub = ["高三诊断性考试(文科)：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-08-26", "07:40", "10:10");
...
exam[241] = function () {
  slogan.$sub = ["高一期末考试：请以实际铃声为准。"];
  subject.$admit = 20;
  $("语文", "2022-06-29", "07:50", "09:50");
  $("生物", "2022-06-29", "10:20", "12:00");
  $("物理", "2022-06-29", "14:20", "16:00");
  $("英语", "2022-06-29", "16:30", "18:10");
  $("史地", "2022-06-30", "07:50", "09:50");
  $("化学", "2022-06-30", "10:20", "12:00");
  $("数学", "2022-06-30", "14:20", "16:00");
  $("政治", "2022-06-30", "16:30", "17:30");
  return "高二";
};
