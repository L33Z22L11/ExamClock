...
exam[231] = function () {
  slogan.$sub = ["高三第一学期月考二(理科)：请以实际铃声为准。"];
  $("英语", "2022-11-04", "08:00", "10:00");
  $("生物", "2022-11-04", "10:30", "12:10");
  $("语文", "2022-11-04", "14:00", "16:30");
  $("数学", "2022-11-05", "08:00", "10:00");
  $("物理", "2022-11-05", "10:30", "12:10");
  $("化学", "2022-11-05", "14:00", "15:40");
  return "高三理科";
};
exam[232] = function () {
  slogan.$sub = ["高三第一学期月考二(文科)：请以实际铃声为准。"];
  $("英语", "2022-11-04", "08:00", "10:00");
  $("地理", "2022-11-04", "10:30", "12:10");
  $("语文", "2022-11-04", "14:00", "16:30");
  $("数学", "2022-11-05", "08:00", "10:00");
  $("政治", "2022-11-05", "10:30", "12:10");
  $("历史", "2022-11-05", "14:00", "15:40");
  return "高三文科";
};
exam[241] = function () {
