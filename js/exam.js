...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2023级月考（八）：请以实际铃声为准。"],
  schedule() {
    $("语文", "2026-04-10", "14:10", "16:40");
    $("物理", "2026-04-10", "17:00", "18:15");
    $("数学", "2026-04-11", "07:50", "09:50");
    $("英语", "2026-04-11", "10:10", "12:10");
    $("选科一", "2026-04-11", "14:10", "15:25");
    $("选科二", "2026-04-11", "15:30", "16:45");
  }
};
