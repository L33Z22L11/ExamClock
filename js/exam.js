...
exams[261] = {
  ...
  author: "来源:心向太阳",
  origin: "2026届年级部",
  rollSlogan: ["2023级高三模考（7）：请以实际铃声为准。"],
  schedule() {
    $("选科一", "2026-05-14", "18:45", "20:00");
    $("选科二", "2026-05-14", "20:05", "21:20");
    $("数学", "2026-05-15", "08:00", "10:00");
    $("英语", "2026-05-15", "10:15", "12:15");
    $("语文", "2026-05-15", "14:25", "16:55");
    $("物理", "2026-05-15", "17:10", "18:25");
  }
};
